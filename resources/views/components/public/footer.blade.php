        ...
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                ...
                <div class="flex items-center gap-3 mt-4">
                    <a href="#" class="w-10 h-10 rounded-xl bg-white/5 border border-slate-800 text-slate-300 flex items-center justify-center hover:bg-slate-700 hover:border-slate-800 hover:text-white transition-all duration-300 shadow-sm" title="Instagram">
                    ...
                    <a href="#" class="w-10 h-10 rounded-xl bg-white/5 border border-slate-800 text-slate-300 flex items-center justify-center hover:bg-red-500 hover:border-red-500 hover:text-white transition-all duration-300 shadow-sm" title="YouTube">
                    ...
                    <a href="#" class="w-10 h-10 rounded-xl bg-white/5 border border-slate-800 text-slate-300 flex items-center justify-center hover:bg-slate-700 hover:border-slate-800 hover:text-white transition-all duration-300 shadow-sm" title="Facebook">
