<header class="h-16 lg:h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-4 lg:px-6 z-30 sticky top-0">
    <div class="flex items-center gap-4">
        <button id="menuToggle" class="p-2 lg:hidden text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded-lg">
            <i data-lucide="menu" class="w-5 h-5"></i>
        </button>
        <button id="desktopToggle" class="hidden lg:flex p-2 text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded-lg transition-colors">
    ...
    <div class="flex items-center gap-4 lg:gap-6">
        ...
        <div class="flex items-center gap-3">
            <div class="hidden sm:block text-right">
                <p class="text-sm font-bold text-slate-700 leading-tight">{{ Auth::user()->name ?? 'Admin' }}</p>
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" 
                    ...
                    <a href="{{ route('admin.profile.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 hover:text-blue-600 transition-colors">
