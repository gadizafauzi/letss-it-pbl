            ...
            <div class="fade-up">
                ...
                <div class="flex items-center gap-4 text-sm text-slate-400 mb-8">
                    <span class="flex items-center gap-1">
                        ...
                        {{ $post ? \Carbon\Carbon::parse($post->publish_date)->translatedFormat('d F Y') : '10 Mei 2026' }}
                    </span>
                    <span class="flex items-center gap-1">
                        <i data-lucide="user" class="w-4 h-4"></i> 
                        {{ $post && $post->author ? $post->author->name : 'Admin' }}
                    </span>
                </div>

                @if($post && $post->featured_image)
                    <div class="w-full aspect-video rounded-2xl overflow-hidden mb-8">
