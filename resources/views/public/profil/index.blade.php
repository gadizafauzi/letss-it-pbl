            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-left reveal reveal-left delay-100">
                    <h1 class="text-4xl sm:text-5xl font-black text-white leading-tight mb-4">
                        Profil SIT Mutiara Qur'an
                    </h1>
                    <p class="text-emerald-100/80 text-lg mb-8 max-w-lg">
                        Membangun generasi Qur'ani yang berkarakter, berprestasi, dan berwawasan global.
                    </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div class="lg:col-span-5 reveal reveal-left delay-100">
                    ...
                    <div class="mt-6 text-center">
                        ...
                        <p class="text-xs font-semibold text-emerald-600 uppercase tracking-widest mt-1">Kepala Sekolah SIT
                            Mutiara Qur'an</p>
                    </div>
                </div>
                    ...
                    <div class="border border-slate-200 rounded-xl overflow-hidden bg-white cursor-pointer hover:border-slate-300 transition-all duration-200"
                        ...
                        <div x-show="open === 'visi'" x-transition:enter="transition ease-out duration-200"
                            ...
                            <p class="text-sm text-slate-600 leading-relaxed">
                                Menjadi lembaga pendidikan Islam terpadu yang unggul dalam membentuk generasi Qur'ani,
            ...
            @php
                $sejarah = [
                    ...
                    [
                        ...
                        'desc' =>
                            'Membuka jenjang PAUD/TK Islam Terpadu untuk memulai pendidikan Qur\'ani sejak usia dini.',
                    ],
                    [
                        'tahun' => '2014',
                        'judul' => 'Akreditasi A',
                        'desc' =>
                            'Meraih akreditasi A dari BAN-S/M untuk jenjang SD Islam Terpadu, membuktikan kualitas pendidikan yang unggul.',
                    ],
                    [
                        'tahun' => '2016',
                        'judul' => 'Wisuda Tahfidz Pertama',
                        'desc' =>
                            'Angkatan pertama program tahfidz berhasil menyelesaikan target hafalan, menandai keberhasilan program unggulan.',
                    ],
                    [
                        'tahun' => '2018',
                        'judul' => 'Pembukaan SMP IT',
                        'desc' =>
                            'Membuka jenjang SMP Islam Terpadu untuk melanjutkan misi pendidikan ke tingkat yang lebih tinggi.',
                    ],
                    [
                        'tahun' => '2023',
                        'judul' => 'Kampus Baru',
                        'desc' =>
                            'Pindah ke kampus baru dengan fasilitas modern termasuk laboratorium, perpustakaan digital, dan area bermain yang luas.',
                    ],
                ];
            @endphp
