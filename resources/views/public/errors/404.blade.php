    ...
    <section class="min-h-[80vh] flex items-center justify-center px-4" style="padding-top:72px;">
        <div class="text-center fade-up">
            ...
            <a href="{{ route('public.home') }}"
                class="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-bold shadow-lg shadow-emerald-200 hover:-translate-y-1 transition-all duration-300">
