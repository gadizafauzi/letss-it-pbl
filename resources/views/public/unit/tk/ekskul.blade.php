...
@section('content')
    ...
    <div class="bg-white border-b border-slate-200 sticky top-[72px] z-30">
        <div class="w-full flex gap-2 overflow-x-auto py-3 public-subnav-container no-scrollbar">
            ...
            <a href="{{ route('public.unit.tk.ekskul') }}" class="px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap bg-emerald-500 text-white">Ekstrakurikuler</a>
    ...
    <section class="public-section">
        <div class="w-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @php $ekskul = [['icon'=>'music','title'=>'Drumband Mini','desc'=>'Melatih motorik dan kekompakan melalui musik.'],['icon'=>'palette','title'=>'Mewarnai & Menggambar','desc'=>'Mengembangkan kreativitas dan imajinasi anak.'],['icon'=>'mic','title'=>'Menyanyi Islami','desc'=>'Lagu-lagu Islami dan nasyid untuk anak-anak.'],['icon'=>'book-open','title'=>'Storytelling','desc'=>'Bercerita kisah Nabi dan sahabat.'],['icon'=>'dumbbell','title'=>'Senam Ceria','desc'=>'Aktivitas fisik yang menyenangkan.'],['icon'=>'scissors','title'=>'Prakarya','desc'=>'Membuat kerajinan tangan sederhana.']]; @endphp
                @foreach($ekskul as $e)
                <div class="feature-card fade-up">
                    <div class="feature-icon bg-pink-50 text-pink-500"><i data-lucide="{{ $e['icon'] }}" class="w-6 h-6"></i></div>
