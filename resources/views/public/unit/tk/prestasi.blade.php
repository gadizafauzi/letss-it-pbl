...
@section('content')
    ...
    <div class="bg-white border-b border-slate-200 sticky top-[72px] z-30">
        <div class="w-full flex gap-2 overflow-x-auto py-3 public-subnav-container no-scrollbar">
            ...
            <a href="{{ route('public.unit.tk.prestasi') }}" class="px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap bg-emerald-500 text-white">Prestasi</a>
        </div>
    </div>
        ...
        <div class="w-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="feature-card fade-up">
                    <span class="text-xs font-bold text-pink-600 bg-pink-50 px-2.5 py-1 rounded-full">{{ $p['tahun'] }}</span>
