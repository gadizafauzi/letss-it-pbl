            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative hidden lg:block reveal reveal-right">
                    <div class="relative w-full h-[400px] lg:h-[500px] animate-floating">
                        ...
                        <img src="{{ asset('images/tk_dummy.png') }}" alt="TK Islam Terpadu SIT Mutiara Qur'an" class="relative w-full h-full object-contain mix-blend-screen drop-shadow-2xl">
                    </div>
                </div>
    ...
    <section id="profil" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                <h2 class="unit-section-title block w-full">DESKRIPSI TK</h2>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal reveal-right">
                    <h3 class="text-2xl font-bold text-slate-800 mb-6">Pondasi Kuat untuk Generasi Qur'ani</h3>
    ...
    <section id="guru" class="py-24" style="background: #f8fafc;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                ...
                <p class="text-slate-500 mt-4 max-w-2xl mx-auto">Dibimbing oleh pendidik yang penyayang, kompeten, dan berdedikasi dalam mendidik anak usia dini.</p>
            </div>
    ...
    <section id="ekstrakurikuler" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                ...
                <p class="text-slate-500 mt-4 max-w-xl mx-auto">Beragam kegiatan seru untuk mengembangkan bakat dan kreativitas anak sejak dini.</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                ...
                <p class="mt-4 max-w-xl mx-auto" style="color: rgba(255,255,255,0.5);">
                    Sarana lengkap yang aman, nyaman, dan ramah anak untuk mendukung tumbuh kembang optimal.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div class="grid grid-cols-2 gap-3 reveal reveal-left">
                    ...
                    <img src="https://images.unsplash.com/photo-1540553016722-983e48a2cd10?auto=format&fit=crop&w=400&q=80"
                         class="rounded-2xl object-cover w-full" style="height:200px;" alt="Area Bermain">
                    <img src="https://images.unsplash.com/photo-1629752187687-3d3c7ea3a21b?auto=format&fit=crop&w=400&q=80"
                         class="rounded-2xl object-cover w-full col-span-2" style="height:200px;" alt="Playground">
                </div>
                <div class="reveal reveal-right">
                    <div class="grid grid-cols-2 gap-4">
                        @foreach([
                            ['air-vent','Ruang Kelas Full AC'],['puzzle','Area Bermain Indoor'],
                            ['trees','Playground Outdoor'],['moon','Musholla'],
                            ['library','Perpustakaan Mini'],['stethoscope','UKS'],
                            ['cctv','Keamanan CCTV'],['car','Area Parkir Luas']
                        ] as $f)
    ...
    <section id="prestasi" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                ...
                <p class="text-slate-500 mt-4 max-w-xl mx-auto">Capaian membanggakan dari siswa-siswi TK Islam Terpadu SIT Mutiara Qur'an.</p>
            </div>
            ...
            <div class="relative ml-6 md:ml-0 md:max-w-2xl md:mx-auto"
                ...
                @php
                    $prestasi = [
                        ['2024','Juara 1 Lomba Tahfidz Tingkat Kota','Kategori Hafalan Surat Pendek antar TK.'],
                        ['2023','Juara Harapan Mewarnai Kaligrafi','Festival Anak Sholeh se-Provinsi.'],
                        ['2023','Sekolah Sehat Berkarakter','Penghargaan dari Dinas Pendidikan setempat.'],
                        ['2022','Juara 2 Tari Islami Kreasi','Pekan Olahraga dan Seni PAUD.'],
                    ];
                @endphp
