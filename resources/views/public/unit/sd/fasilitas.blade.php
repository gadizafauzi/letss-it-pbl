...
@section('content')
    ...
    <div class="bg-white border-b border-slate-200 sticky top-[72px] z-30">
        <div class="w-full flex gap-2 overflow-x-auto py-3 public-subnav-container no-scrollbar">
            ...
            <a href="{{ route('public.unit.sd.fasilitas') }}" class="px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap bg-emerald-500 text-white">Fasilitas</a>
        ...
        <div class="w-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="feature-card fade-up">
                    <div class="feature-icon bg-emerald-50 text-emerald-500"><i data-lucide="{{ $f['icon'] }}" class="w-6 h-6"></i></div>
