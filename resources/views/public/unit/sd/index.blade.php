            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal reveal-left">
                    ...
                    <p class="text-lg text-slate-400 leading-relaxed mb-8 max-w-md">
                        Membangun generasi cerdas, mandiri, dan berakhlak mulia dengan memadukan kurikulum nasional dan nilai-nilai keislaman secara komprehensif.
                    </p>

                    <div class="flex flex-wrap gap-4">
                        <a href="#profil"
                           style="background: linear-gradient(135deg, #10b981, #059669); color: white;"
                           class="inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-bold text-sm shadow-lg hover:-translate-y-1 hover:shadow-emerald-500/30 transition-all duration-300">
                ...
                <div class="relative hidden lg:block reveal reveal-right">
                    <div class="relative w-full h-[400px] lg:h-[500px] animate-floating">
                        ...
                        <img src="{{ asset('images/sd_dummy.png') }}" alt="SD Islam Terpadu SIT Mutiara Qur'an" class="relative w-full h-full object-contain mix-blend-screen drop-shadow-2xl">
                    </div>
                </div>
    ...
    <section id="profil" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                <h2 class="unit-section-title block w-full">DESKRIPSI SD</h2>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal reveal-right">
                    <h3 class="text-2xl font-bold text-slate-800 mb-6">Pendidikan Dasar Berbasis Karakter Islami</h3>
                    <div class="space-y-6 text-lg text-slate-600 leading-relaxed">
                        <p>
                            SD Islam Terpadu SIT Mutiara Qur'an memadukan kurikulum nasional dengan nilai-nilai keislaman secara komprehensif, menciptakan lingkungan yang kondusif bagi perkembangan intelektual, spiritual, dan emosional siswa.
                        </p>
                        <p>
    ...
    <section id="guru" class="py-24" style="background: #f8fafc;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                ...
                <p class="text-slate-500 mt-4 max-w-2xl mx-auto">Dibimbing oleh pendidik profesional yang berkompeten di bidangnya serta berdedikasi membina akhlak siswa.</p>
            </div>
    ...
    <section id="prestasi" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                ...
                <p class="text-slate-500 mt-4 max-w-xl mx-auto">Bukti dedikasi dan kualitas pendidikan SD IT Mutiara Qur'an di berbagai kompetisi.</p>
            </div>
            ...
            <div class="relative ml-6 md:ml-0 md:max-w-2xl md:mx-auto"
                ...
                @php
                    $prestasi = [
                        ['2024','Medali Emas Olimpiade Sains Nasional (OSN)','Tingkat Kabupaten/Kota untuk mata pelajaran Matematika.'],
                        ['2023','Juara Umum Lomba Cerdas Cermat PAI','Kompetisi antar SD IT se-Provinsi.'],
                        ['2023','Juara 1 Lomba Tahfidz Al-Qur\'an','Kategori 2 Juz pada MTQ Pelajar.'],
                        ['2022','Regu Tergiat Pramuka Penggalang','Jambore Ranting tingkat Kecamatan.'],
                    ];
                @endphp
