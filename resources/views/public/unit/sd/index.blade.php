...
<div class="theme-sd">
    ...
    <style>
        /* ── Hero light theme ─────────────────────── */
        .sd-hero {
            background: linear-gradient(135deg, #faf5ff 0%, #f3e8ff 40%, #f5f3ff 70%, #ede9fe 100%);
            position: relative;
            overflow: hidden;
            min-height: 100vh;
            display: flex;
        ...
        .sd-hero-badge-inner {
            ...
            border-radius: 50%;
            background: #faf5ff;
            box-shadow: 0 8px 28px rgba(0,0,0,0.10), 0 0 0 4px rgba(168,85,247,0.08);
        ...
        .sd-hero-badge-inner .badge-flower {
            font-size: 1.5rem;
            position: absolute;
            top: 50%;
            left: 50%;
                ...
                <div id="guruCarouselTrack" class="flex gap-4 transition-transform duration-700 ease-in-out">
                    ...
                    @if(!empty($displayTeachers))
                        ...
                        <div class="guru-card flex-shrink-0" style="width: calc(20% - 12.8px); min-width: 150px;">
                            <div class="rounded-2xl overflow-hidden shadow-md bg-white transition-all duration-300 hover:-translate-y-2 hover:shadow-xl" style="border:1px solid rgba(168,85,247,0.12);">
                                {{-- Photo --}}
                                <div style="aspect-ratio:3/4; overflow:hidden; position:relative;">
                                    <img src="{{ $g['photo'] }}" alt="{{ $g['name'] }}"
                                        style="width:100%; height:100%; object-fit:cover; transition: transform 0.5s ease;">
                                    {{-- Gradient overlay bottom --}}
                                    <div style="position:absolute; inset:0; background: linear-gradient(to top, rgba(147,51,234,0.85) 0%, transparent 55%);"></div>
                                    {{-- Name on photo --}}
                ...
                @foreach ($displayEkskuls as $idx => $e)
                    <div class="group relative rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 reveal"
                        ...
                        <div class="absolute inset-0 transition-opacity duration-300"
                            style="background: linear-gradient(to top, rgba(49,10,80,0.92) 0%, rgba(49,10,80,0.2) 60%, transparent 100%);">
                        </div>
                        <div class="absolute bottom-0 left-0 right-0 p-3 md:p-4">
                            <div class="w-7 h-7 md:w-8 md:h-8 rounded-lg mb-1.5 md:mb-2 flex items-center justify-center"
                                style="background: rgba(147,51,234,0.18); color:#d8b4fe; border:1px solid rgba(147,51,234,0.3);">
    ...
    <section id="fasilitas" class="py-24 relative bg-fixed bg-center bg-cover overflow-hidden"
        ...
        {{-- Purple overlay --}}
        <div class="absolute inset-0 bg-gradient-to-b from-[#f3e8ff] via-[#f3e8ff]/50 to-[#f3e8ff] z-0"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            @php
                ...
                $lvlColor = [
                    ...
                    'Kabupaten'     => ['bg'=>'#f3e8ff', 'text'=>'#9333ea'], // Purple for kabupaten (SD theme color)
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="reveal group" style="transition-delay: {{ ($idx % 4) * 80 }}ms;">
                    <div class="rounded-2xl overflow-hidden bg-white shadow-md hover:shadow-xl transition-all duration-400 hover:-translate-y-2"
                        style="border:1px solid rgba(168,85,247,0.10);">

                        {{-- Photo area --}}
                        <div style="position:relative; aspect-ratio:4/3; overflow:hidden; background:#f3e8ff;">
                            @if($p['studentPhoto'])
                            ...
                            @else
                                ...
                                <div style="width:100%; height:100%; display:flex; align-items:center; justify-content:center; flex-direction:column; gap:0.5rem;">
                                    <div style="width:72px; height:72px; border-radius:50%; background:rgba(168,85,247,0.15); display:flex; align-items:center; justify-content:center;">
                                        <i data-lucide="trophy" style="width:32px; height:32px; color:#a855f7;"></i>
                                    </div>
                                </div>
                            @endif
                            ...
                            <span style="position:absolute; top:0.6rem; right:0.6rem; font-size:0.6rem; font-weight:700; padding:0.2rem 0.55rem; border-radius:999px;
                                background:rgba(255,255,255,0.9); color:#a855f7; border:1px solid rgba(168,85,247,0.2);">
                                {{ $p['year'] }}
                            </span>
