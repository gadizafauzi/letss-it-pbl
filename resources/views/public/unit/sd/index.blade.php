            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal reveal-left">
                    ...
                    <p class="text-base text-slate-400 leading-relaxed mb-8 max-w-md">
                        Membangun generasi cerdas, mandiri, dan berakhlak mulia dengan memadukan kurikulum nasional dan
                        nilai-nilai keislaman secara komprehensif.
                    </p>
                ...
                <div class="relative hidden lg:block reveal reveal-right">
                    <div class="relative w-full h-[400px] lg:h-[480px] animate-floating">
                        ...
                        <img src="{{ asset('images/sd_dummy.png') }}" alt="SD Islam Terpadu SIT Mutiara Qur'an"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="reveal reveal-right">
                    <h3 class="text-xl font-bold text-slate-800 mb-5">Pendidikan Dasar Berbasis Karakter Islami</h3>
