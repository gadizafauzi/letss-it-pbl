...
@section('content')
    ...
    <section class="public-section">
        <div class="w-full">
            <div class="text-center mb-14 fade-up"><span class="section-badge"><i data-lucide="users" class="w-4 h-4"></i> Tenaga Pendidik</span><h2 class="section-title mx-auto">Guru SMP Islam Terpadu</h2></div>
