            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div class="xl:col-span-9">
                    <div class="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl border border-white/80 dark:border-slate-700/60 rounded-[2rem] shadow-sm p-6 space-y-5">
                        ...
                        {{-- GURU --}}
                        <div>
                            <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Guru <span class="text-red-500">*</span></label>
                        ...
                        {{-- MAPEL --}}
                        <div>
                            <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Mata Pelajaran <span class="text-red-500">*</span></label>
                        ...
                        {{-- KELAS --}}
                        <div>
                            <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Kelas <span class="text-red-500">*</span></label>
                        ...
                        {{-- TAHUN AJARAN --}}
                        <div>
                            <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Tahun Ajaran <span class="text-red-500">*</span></label>
