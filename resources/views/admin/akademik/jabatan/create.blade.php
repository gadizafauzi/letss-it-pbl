...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-xl font-bold text-slate-800 dark:text-slate-100">Tambah Jabatan</h1>
        </div>
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                ...
                                class="w-full h-12 px-4 rounded-2xl border bg-white/50 dark:bg-slate-900/50 border-sky-100 dark:border-slate-600 focus:bg-white focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-400 text-sm text-slate-700 dark:text-slate-200 transition-all @error('name') border-red-400 @enderror">
                            @error('name')
