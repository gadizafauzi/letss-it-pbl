...
use App\Http\Requests\Admin\Akademik\StoreKelasRequest;
use App\Http\Requests\Admin\Akademik\UpdateKelasRequest;
use App\Http\Requests\Admin\Akademik\BulkDestroyKelasRequest;
...
class KelasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.akademik.kelas.index', compact(
            'classes',
            'units'
        ));
    }
    ...
    public function create()
    {
        ...
        return view('admin.akademik.kelas.create', compact(
            'units',
            'teachers'
        ));
    }
    ...
    public function show(SchoolClass $kela)
    {
        ...
        return view('admin.akademik.kelas.show', [
     ...
     * =========================================================
     */
    public function bulkDestroy(BulkDestroyKelasRequest $request)
    {
        $ids = $request->ids;
        $deleted = 0;
        $failed = 0;
        ...
        foreach ($ids as $id) {
            $used = StudentClass::where('class_id', $id)->exists();
            if ($used) {
                $failed++;
            } else {
        ...
        $message = "Berhasil menghapus $deleted kelas.";
        if ($failed > 0) {
            $message .= " Gagal menghapus $failed kelas karena masih memiliki data siswa.";
        }
