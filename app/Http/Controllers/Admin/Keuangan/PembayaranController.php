...
use App\Http\Requests\Admin\Keuangan\StorePembayaranRequest;
...
class PembayaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.keuangan.pembayaran.index', compact('payments'));
    }
    ...
    public function show(Payment $payment)
    {
        ...
        return view('admin.keuangan.pembayaran.show', compact('payment'));
    }
    ...
    public function print(Payment $payment)
    {
        ...
        return view('admin.keuangan.pembayaran.print', compact('payment', 'transactionCode'));
    }
}
